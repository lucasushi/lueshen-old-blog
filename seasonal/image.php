				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<footer class="entry-footer">
                        ...
                        <nav id="image-navigation" class="navigation image-navigation">
                            <div class="nav-links">
                                <div class="nav-previous"><?php previous_image_link( false, esc_html__( 'Previous Image', 'seasonal' ) ); ?></div>
                                <div class="nav-next"><?php next_image_link( false, esc_html__( 'Next Image', 'seasonal' ) ); ?></div>
                            </div>
                        </nav>                    
