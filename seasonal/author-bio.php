...
<div class="author-info" itemscope="" itemtype="http://schema.org/Person">
	...
	<div class="author-description">
		<h3 class="author-title" itemprop="name"><?php esc_html_e( 'Published by', 'seasonal' ); ?><span class="author-name"><?php echo get_the_author(); ?></span></h3>

		<p class="author-bio">
			<?php the_author_meta( 'description' ); ?>
			<a class="author-link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author" itemprop="url">
				<?php printf( esc_html__( 'View all posts by %s', 'seasonal' ), get_the_author() ); ?>
			</a>
		</p><!-- .author-bio -->
